...
// This icon is a taken from Material Icons: https://github.com/mui/material-ui/tree/master/packages/mui-icons-material

const SubtitlesOffIcon = (props: SvgIconProps) => {
    return (
        <SvgIcon {...props}>
