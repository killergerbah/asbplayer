                ...
                >
                    <List>
                        {disabledDirection !== Direction.up && onOrderChange !== undefined && (
                            <ListItem onClick={() => handleOrderChange(Direction.up)}>
                                <ListItemButton>
                                    <ListItemIcon>
                        ...
                        {display !== undefined && onDisplayChange !== undefined && (
                            ...
                            >
                                <ListItem onClick={() => onDisplayChange(!display)}>
                                    <ListItemButton>
                                        <ListItemIcon>
                        ...
                        {disabledDirection !== Direction.down && onOrderChange !== undefined && (
                            <ListItem onClick={() => handleOrderChange(Direction.down)}>
                                <ListItemButton>
                                    <ListItemIcon>
