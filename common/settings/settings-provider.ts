...
export const defaultSettings: AsbplayerSettings = {
    ...
    keyBindSet: {
        ...
        increaseSubtitlePositionOffset: { keys: isMacOs ? '⇧+V' : 'shift+V' },
        decreaseSubtitlePositionOffset: { keys: isMacOs ? '⇧+B' : 'shift+B' },
        increaseTopSubtitlePositionOffset: { keys: isMacOs ? '⇧+Y' : 'shift+Y' },
        decreaseTopSubtitlePositionOffset: { keys: isMacOs ? '⇧+U' : 'shift+U' },
    },
