...
export const defaultSettings: AsbplayerSettings = {
    ...
    keyBindSet: {
        ...
        moveBottomSubtitlesUp: { keys: isMacOs ? '⇧+V' : 'shift+V' },
        moveBottomSubtitlesDown: { keys: isMacOs ? '⇧+B' : 'shift+B' },
        moveTopSubtitlesUp: { keys: isMacOs ? '⇧+Y' : 'shift+Y' },
        moveTopSubtitlesDown: { keys: isMacOs ? '⇧+U' : 'shift+U' },
    },
