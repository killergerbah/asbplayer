...
it('validates exported settings', () => {
    validateSettings({
        ...
        keyBindSet: {
            ...
            increaseSubtitlePositionOffset: { keys: '⇧+V' },
            decreaseSubtitlePositionOffset: { keys: '⇧+B' },
            increaseTopSubtitlePositionOffset: { keys: '⇧+Y' },
            decreaseTopSubtitlePositionOffset: { keys: '⇧+U' },
        },
